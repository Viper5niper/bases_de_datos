...
<div class="container">
    <div class="row">
        <div class="col-lg-12 card d-flex justify-content-center mx-auto p-5">       
            <form class="form-horizontal" method="POST" action="{{ route('pagos.update',$pago->id) }}" enctype="multipart/form-data">
                @method('PATCH')
                @include('pagos.form',['btnText'=>'Guardar Cambios'])
            </form>
        </div>
    </div>
</div>
