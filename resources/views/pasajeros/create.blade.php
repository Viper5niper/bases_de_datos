...
@include('common.status')
  ...
  <div class="card col-lg-12 d-flex justify-content-center p-3">
    <div class="row">
      ...
      <div class="">
        <a href="{{ route('pasajero.index') }}" class="btn btn-md btn-secondary float-right"><i
...
<div class="container">
    <div class="row">
        <div class="col-lg-12 card d-flex justify-content-center mx-auto p-5">       
            <form class="form-horizontal" method="POST" action="{{ route('pasajero.store') }}" enctype="multipart/form-data">
