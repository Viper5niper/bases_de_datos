...
<div class="form-row">
    ...
    <div class="form-group col-md-6">
        ...
        @enderror" id="id_ciudad" placeholder="San Salvador" value="{{old('ciudad',$ubicacion->ciudad)}}"
            onKeyUp="n_ciudad_mask(this);" required>
        @error('telefono')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" name="latitud" class="form-control @error('latitud') is-invalid 
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" name="longitud" class="form-control @error('longitud') is-invalid 
